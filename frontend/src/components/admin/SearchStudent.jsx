              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-100">
                    ...
                    <th className="p-2 text-left border">Year of Admission</th>
                ...
                <tbody>
                  {getAllStudents().map((student) => (
                    <tr key={student.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-2 border">{student.yearOfAdmission}</td>
                        ...
                        <Dialog>
                          ...
                          <DialogContent>
                            ...
                            <div className="mt-4 grid grid-cols-2 gap-4">
                              ...
                              <div>
                                <p className="text-sm font-medium mb-1">CGPA</p>
                                <p>{student.cgpa}</p>
                              </div>
                              <div>
                                <p className="text-sm font-medium mb-1">
                            ...
                            <Dialog>
                              <DialogTrigger>
                                <Button
                                  ...
                                  onClick={() => handleInfoButtonClick(student)}
                                >
